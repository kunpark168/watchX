...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangViewHolder> {
    ...
    public GioHangViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.giohangitem, parent, false);
...
//
//                setCheck(isChecked);
//                longTienBanDau = Long.parseLong(tongTien);// tổng tiền ban đầu
//
...
//                    });
//
//                    tong1 += longTienBanDau;
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
//                        Fragment_GioHang.setTongTien(NumberFormat.getNumberInstance(Locale.US).format(tong1));
//                    }
//
//                } else {
//
